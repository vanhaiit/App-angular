...
const imageError = ["empty+cut_slim", "empty", "fit_baggy", "fit_slim", "empty+fit_slim", "empty+fit_baggy",
    ...
    "interior+espalda_unlined+x", "interior+espalda_arriba+unlined_v2", "interior+espalda_abajo+length_long+unlined_v2", "interior+espalda_arriba+unlined_v2+x", "neck_single_breasted+buttons_5+lapel_medium+style_lapel_no"
]
